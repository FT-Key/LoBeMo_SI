...
## Request
Sistema de gestion de proyectos para LoBeMo Seguridad Informatica - empresa de ciberseguridad con 11 empleados en Tucuman, NOA. Sistema web interno single-tenant para administrar clientes, proyectos (con flujo de 7 estados), propuestas, asignacion de empleados, tareas, hitos, documentos, notificaciones y dashboard ejecutivo.

## Clarified Scope
- **IN:** Gestion de empleados (11 roles), clientes, proyectos con ciclo de vida completo, propuestas, tareas, asignaciones, hitos, documentos, notificaciones, dashboard ejecutivo, audit log, reportes de pentesting y auditoria, gestion de capacitaciones.
- **OUT:** Facturacion electronica/AFIP, pasarela de pagos, multi-tenancy, app movil nativa, integracion con email (post-MVP), calendario externo.
- **MVP:** US-001 a US-009 (autenticacion, clientes, servicios, proyectos, propuestas, asignaciones, tareas, hitos, dashboard).
...
|----|--------|--------|----|--------|
| US-001 | Done | feat/US-001-autenticacion | PR #1 to dev, PR #2 to main | .opencode/workflow/history/US-001.md |

## Project Status
- Fase de analisis de requisitos COMPLETA.
- TP1 y TP2 leidos y procesados.
...
## Next Steps
1. **[PROXIMA] US-021: Landing page con identidad visual LoBeMo** - prioritaria
2. Continuar con **US-002: Gestion de clientes**