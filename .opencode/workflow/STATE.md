...
| US-067 | ✅ Done | fix/US-067-encoding-docs-nav | PR → dev | .opencode/workflow/history/US-067.md |
...
## Último Cambio
**US-067: Fix encoding, documentos nueva pestaña y hrefs** — Branch `fix/US-067-encoding-docs-nav`, PR → dev
