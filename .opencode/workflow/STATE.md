...
| US-030 | ✅ Done | feat/US-030-form-validations | — | .opencode/workflow/history/US-030.md |
| US-031 | ✅ Done | feat/US-031-login-secure-cookie | PR # → dev, PR # → main | .opencode/workflow/history/US-031.md |
## Project Status
