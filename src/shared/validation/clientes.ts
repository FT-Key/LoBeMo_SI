...
export const SECTORES_LABELS: Record<string, string> = {
  SALUD: "Salud",
  CONTABLE_JURIDICO: "Contable / Jurídico",
  COMERCIAL: "Comercial",
  LOGISTICA: "Logística",
...
export const createClienteSchema = z.object({
  ...
  sector: z.enum(SECTORES, { message: "Seleccioná un sector válido" }).optional().or(z.literal("")),
})
